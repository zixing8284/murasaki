...
Windows 98 风格的 React 组件库 — [`@murasaki-io/react98`](https://www.npmjs.com/package/@murasaki-io/react98)

- [Playground](https://zixing8284.github.io/murasaki/) · [文档](https://zixing8284.github.io/murasaki/programs/docs/)

## 这是什么

Murasaki 是一个忠实还原 Windows 98 美学的 React 组件库。它以 `@murasaki-io/react98` 发布到 npm，并驱动这个 Playground —— 一个完全运行在浏览器中的交互式 Windows 98 桌面。
...
- `packages/ui` — `@murasaki-io/react98` 组件库
