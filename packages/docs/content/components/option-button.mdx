...
import { OptionButtonDisabledDemo } from './option-button/option-button-disabled'
...
<ComponentExample name="option-button-disabled" title="Disabled options">
  <OptionButtonDisabledDemo />
</ComponentExample>
