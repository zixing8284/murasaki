...
import { SliderDisabledDemo } from './slider/slider-disabled'
import { SliderFillDemo } from './slider/slider-fill'
...
| `fill` | `boolean` | `false` | Renders a filled progress portion of the track from `min` to the current value. |
...
<ComponentExample name="slider-disabled" title="Disabled states">
  <SliderDisabledDemo />
</ComponentExample>

<ComponentExample name="slider-fill" title="Filled progress">
  <SliderFillDemo />
</ComponentExample>
