export const tableBasicSource = String.raw`import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from 'murasaki-react98'
...
export function TableBasicExample(): React.ReactElement {
  return (
