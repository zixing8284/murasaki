export const taskbarBasicSource = String.raw`import { Button, Taskbar, TaskbarDivider, TaskbarNotificationArea, TaskbarQuickLaunch, TaskbarSystemClock } from 'murasaki-react98'
...
export function TaskbarBasicExample(): React.ReactElement {
  return (
