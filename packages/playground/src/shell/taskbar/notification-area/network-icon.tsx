...
const NETWORK_ONLINE_ICONS = [
  assetPath('/img/conn_pcs_on_off.png'),
  assetPath('/img/conn_pcs_off_on.png'),
  assetPath('/img/conn_pcs_on_on.png'),
]
const NETWORK_OFFLINE_ICON = assetPath('/img/conn_pcs_no_network.png')
