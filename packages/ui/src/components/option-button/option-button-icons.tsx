...
export function RadioBorderIcon({ disabled, ...props }: React.SVGProps<SVGSVGElement> & { disabled?: boolean | undefined }): React.ReactElement {
  return (
    <svg fill="none" height={12} viewBox="0 0 12 12" width={12} {...props}>
      ...
      <path clipRule="evenodd" d="M4 2H8V3H9V4H10V8H9V9H8V10H4V9H3V8H2V4H3V3H4V2Z" fill={disabled ? 'var(--button-face)' : 'var(--window)'} fillRule="evenodd" />
    </svg>
  )
}
